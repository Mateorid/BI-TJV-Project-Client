...
public class EquipmentResource {
    ...
    public URI create(EquipmentModel data) {
    ...
    public PagedModel<EquipmentModel> readByAvailability(String bool, int page, int size) { //todo funguje? xd
    ...
    public PagedModel<EquipmentModel> readBySizeAndType(String eqSize, String type, int page, int size) { //todo funguje? xd
        ResponseEntity<PagedModel<EquipmentModel>> response = restTemplate.exchange(
